...
contract Pool is LPTokenERC20, ReentrancyGuard {
    ...
    function swap(
        ...
        s.amount = amountSD.sub(s.eqFee).sub(s.protocolFee).sub(s.lpFee);  // - 0.0006
//        console.log("-eqFee: %s", s.eqFee); // 0.00003
//        console.log("-protocolFee: %s", s.protocolFee); // 0.00012
//        console.log("-lpFee: %s", s.lpFee); // 0.00045
