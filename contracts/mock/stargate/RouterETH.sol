...
contract RouterETH {
    ...
    // this is a legacy method, that does not accept a payload.
    function swapETH(
    ...
    // this method can compose stargate, to send an arbitrary payload to your contract on remote chain
    // that implements sgReceive()
